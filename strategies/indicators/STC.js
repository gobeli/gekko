...
Indicator.prototype.update = function(price) {
  ...
  const v1 = Math.min.apply(Math, this.historyMACD);
  const v2 = Math.max.apply(Math, this.historyMACD) - v1;
  ...
  const v3 = Math.min.apply(Math, this.historyPF);
  const v4 = Math.max.apply(Math, this.historyPF) - v3;
